...
List<CountriesList> countriesListFromJson(String str) =>
    List<CountriesList>.from(
        json.decode(str).map((x) => CountriesList.fromJson(x)));

String countriesListToJson(List<CountriesList> data) =>
...
class CountriesList {
  ...
  CountriesList.fromJson(Map<String, dynamic> json) {
    ...
    tld = ((json['tld'] ?? []) as List).map((item) => item as String).toList();
    cca2 = json['cca2'];
    ccn3 = json['ccn3'];
    cca3 = json['cca3'];
    cioc = json['cioc'];
...
class Idd {
  ...
  Idd.fromJson(Map<String, dynamic> json) {
    root = json['root'];
    suffixes = ((json['suffixes'] ?? []) as List)
        .map((item) => item as String)
        .toList();
  }
//((json['signs'] ?? []) as List).map((item) => item as String).toList();
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
    data['root'] = root;
...
class CapitalInfo {
  ...
  CapitalInfo.fromJson(Map<String, dynamic> json) {
    latlng =
        ((json['latlng'] ?? []) as List).map((item) => item as double).toList();
  }
//((json['signs'] ?? []) as List).map((item) => item as String).toList();
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = <String, dynamic>{};
